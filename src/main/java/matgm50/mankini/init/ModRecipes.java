...
public class ModRecipes {
    ...
    public static void init() {
        //addShapedRecipe(new ItemStack(ModItems.dyeable_mankini), "X X", "X X", " X ", 'X',  new ItemStack(Items.LEATHER));
        //addShapedRecipe(new ItemStack(ModItems.kawaii_mankini), "1 7", "2X6", "345", 'X',  new ItemStack(Items.LEATHER),
