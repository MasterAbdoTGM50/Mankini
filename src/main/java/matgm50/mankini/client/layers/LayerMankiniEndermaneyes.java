...
@OnlyIn(Dist.CLIENT)
public class LayerMankiniEndermaneyes implements LayerRenderer<EntityMankiniEnderman> {
    private static final ResourceLocation RES_ENDERMAN_EYES = new ResourceLocation("textures/entity/enderman/enderman_eyes.png");
    private final RenderMankiniEnderman endermanRenderer;

    public LayerMankiniEndermaneyes(RenderMankiniEnderman endermanRendererIn) {
        this.endermanRenderer = endermanRendererIn;
    }

    public void render(EntityMankiniEnderman entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
