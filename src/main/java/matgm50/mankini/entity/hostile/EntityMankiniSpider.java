...
public class EntityMankiniSpider extends EntityMob
{
    ...
    static class AISpiderAttack extends EntityAIAttackMelee
        {
            public AISpiderAttack(EntityMankiniSpider spider)
            {
    ...
    static class AISpiderTarget<T extends EntityLivingBase> extends EntityAINearestAttackableTarget<T>
        {
            public AISpiderTarget(EntityMankiniSpider spider, Class<T> classTarget)
            {
