...
public class MankiniEndermite extends Endermite {

	public MankiniEndermite(EntityType<? extends MankiniEndermite> type, Level level) {
		super(type, level);
	}

	public MankiniEndermite(Level level) {
