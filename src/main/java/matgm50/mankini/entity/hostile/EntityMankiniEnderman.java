...
public class EntityMankiniEnderman extends EntityMob
{
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(10, new EntityMankiniEnderman.AIPlaceBlock(this));
        this.tasks.addTask(11, new EntityMankiniEnderman.AITakeBlock(this));
    ...
    static class AIPlaceBlock extends EntityAIBase
        {
            ...
            public AIPlaceBlock(EntityMankiniEnderman p_i45843_1_)
            {
    ...
    static class AITakeBlock extends EntityAIBase
        {
            ...
            public AITakeBlock(EntityMankiniEnderman p_i45841_1_)
            {
            ...
            public void updateTask()
            {
                ...
                if (EntityMankiniEnderman.CARRIABLE_BLOCKS.contains(block) && flag)
                {
